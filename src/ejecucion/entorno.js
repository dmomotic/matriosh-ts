...
class Entorno {
    ...
    getVariable(id) {
        ...
        if (this.deboBuscarEnFunciones(id) && !entorno_aux_1.EntornoAux.getInstance().estoyBuscandoEnFuncion) {
            entorno_aux_1.EntornoAux.getInstance().estoyBuscandoEnFuncion = true;
            ...
            if (!this.hasFuncion(id_funcion)) {
                entorno_aux_1.EntornoAux.getInstance().estoyBuscandoEnFuncion = false;
                return null;
            }
            ;

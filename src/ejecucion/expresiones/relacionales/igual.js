...
class Igual extends instruccion_1.Instruccion {
    ...
    ejecutar(e) {
        ...
        if (exp1 == null || exp2 == null) {
            errores_1.Errores.getInstance().push(new error_1.Error({ tipo: 'semantico', linea: this.linea, descripcion: `No se puede realizar una operacion igual que con un operador null` }));
            return;
        }
        return exp1 == exp2;

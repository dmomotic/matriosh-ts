...
class MenorIgual extends instruccion_1.Instruccion {
    ...
    ejecutar(e) {
        ...
        //   Errores.getInstance().push(new Error({tipo: 'semantico', linea: this.linea, descripcion: `No se puede realizar una operacion menor igual que con un operador null`}));
        //   return;
        // }
        return exp1 <= exp2;

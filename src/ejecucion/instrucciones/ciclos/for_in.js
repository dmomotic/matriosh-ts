...
class ForIn extends instruccion_1.Instruccion {
    ...
    ejecutar(e) {
        ...
        if (!(arreglo instanceof arreglo_1.Arreglo)) {
            errores_1.Errores.getInstance().push(new error_1.Error({ tipo: 'semantico', linea: this.linea, descripcion: `El for in debe ser ejecutado sobre un tipo Arreglo y esta siendo ejecutado sobre un tipo ${tipo_1.getTipo(arreglo)}` }));
            return;
        }
